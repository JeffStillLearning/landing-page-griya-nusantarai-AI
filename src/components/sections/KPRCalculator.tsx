...
export function KPRCalculator() {
  ...
  const getCicilanFontSize = () => {
    ...
    if (length > 25) return 'text-sm md:text-base lg:text-lg'; 
    if (length > 20) return 'text-base md:text-lg lg:text-xl';
    if (length > 17) return 'text-lg md:text-xl lg:text-2xl';
    if (length > 14) return 'text-xl md:text-2xl lg:text-3xl';
    if (length > 12) return 'text-2xl md:text-4xl lg:text-5xl';
