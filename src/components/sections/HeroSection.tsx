...
export function HeroSection() {
  return (
    <section className="relative min-h-[100svh] flex items-center py-20 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-20">
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-xl text-parchment/80 font-body mb-10 max-w-2xl text-white">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-sm mb-12">
      ...
      {/* Merged Trust Bar Content */}
      <div className="absolute bottom-0 left-0 w-full z-20 bg-primary/80 backdrop-blur-md py-6 border-t border-parchment/10">
